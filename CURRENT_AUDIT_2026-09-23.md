...
- Full backend suite currently passes **140 tests with 1 upstream deprecation warning** on Python 3.11 after the opt-out and worker-idempotency fixes. These source changes are not yet in the published audit baseline; verify Git state and CI after commit.
